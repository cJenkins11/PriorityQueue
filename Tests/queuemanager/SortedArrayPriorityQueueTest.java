...
public class SortedArrayPriorityQueueTest {
    ...
    public void testHead() throws QueueOverflowException, QueueUnderflowException {
        testQueue = new SortedArrayPriorityQueue(3);
    ...
    public void overflowTest() throws QueueOverflowException {
        testQueue = new SortedArrayPriorityQueue(1);
